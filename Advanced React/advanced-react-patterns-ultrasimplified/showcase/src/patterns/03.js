...
const MediumClap = ({children, onClap}) => {
    ...
    return (<Provider value={memoizedValue}>
        <button ref={setAllRef} data-refkey="clapRef" id="clap-btn" className={styles.clap}
...
const ClapCount = () => {
    ...
    return <span ref={setAllRef} data-refkey="clapCountRef" className={styles.count}>+{count}</span>
}

const ClapTotal = () => {
    const {totalCount, setAllRef} = React.useContext(MediumClapContext);
    return <span ref={setAllRef} data-refkey="clapTotalRef" className={styles.total}>{totalCount}</span>
}
